...
1. これらのファイルをGitHubにpushし、GitHub Pagesを有効化する。(Settings → Pages → Branch: main / root)
...
1. **Please contact us first** at [Google forms📬️](https://docs.google.com/forms/d/e/1FAIpQLSdXV4cZdQdfSzytiWLUNCQvRCg_KgM-53nWvkWb8MZu5y3ATA/viewform) with details of the content in question.
